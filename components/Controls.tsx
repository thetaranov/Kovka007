...
const RoofIcon: React.FC<{ type: RoofType; active: boolean }> = ({ type, active }) => {
    ...
    if (type === RoofType.Arched) { return <svg width="100%" height="24" viewBox="0 0 40 24" fill="none" className="mx-auto"><path d="M2 20C2 20 10 4 20 4C30 4 38 20 38 20" stroke={color} strokeWidth="2" strokeLinecap="round"/><path d="M2 20L38 20" stroke={color} strokeWidth="1" strokeDasharray="4 2"/></svg>; }
    if (type === RoofType.SemiArched) { return <svg width="100%" height="24" viewBox="0 0 40 24" fill="none" className="mx-auto"><path d="M2 20C10 20, 25 4, 38 4" stroke={color} strokeWidth="2" strokeLinecap="round"/><path d="M2 23C10 23, 25 7, 38 7" stroke={color} strokeWidth="1"/></svg>; }
    if (type === RoofType.Gable) { return <svg width="100%" height="24" viewBox="0 0 40 24" fill="none" className="mx-auto"><path d="M2 20L20 4L38 20" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/><path d="M20 4V20" stroke={color} strokeWidth="1"/></svg>; }
    if (type === RoofType.Triangular) { return <svg width="100%" height="24" viewBox="0 0 40 24" fill="none" className="mx-auto"><path d="M2 20L38 4V20H2Z" stroke={color} strokeWidth="2" strokeLinejoin="round" fill={fill}/><path d="M2 20L38 4" stroke={color} strokeWidth="2"/></svg>; }
